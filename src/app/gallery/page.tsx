    ...
    <section className="">
      ...
      <div className="flex">
        <div className="flex-1">
          <Image src="/Gallery/image1.png" alt="alt" width={2000} height={50}    className='h-[70vh] w-[50vw] object-contain'/>
        </div>
        <div className="flex-1">
          <div className="flex-1/2">
            <Image src="/Gallery/image1.png" alt="alt" width={2000} height={50}  />
          </div>
          <div className="flex-1/2">
            <Image src="/Gallery/image1.png" alt="alt" width={2000} height={50}  />
          </div>
